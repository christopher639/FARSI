import { Bell, Search, User, Signal, Clock } from "lucide-react";
...
export function Header() {
  ...
  return (
    <header className="h-16 border-b border-panel-border bg-card/50 backdrop-blur-sm flex items-center justify-between px-6">
      {/* Left Section */}
      ...
      <div className="flex items-center gap-4">
        {/* Time Display */}
        <div className="hidden lg:flex items-center gap-2 text-muted-foreground font-mono text-sm">
        ...
        {/* Divider */}
        <div className="h-8 w-px bg-panel-border hidden lg:block" />
